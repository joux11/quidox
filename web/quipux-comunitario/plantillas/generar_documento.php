...
//echo str_replace("<", "&lt;", $this->documento_html);
    ...
    *******************************************************************************/
    function inicializar_variables($radi_nume, $firma_digital) {
        ...
        $this->numero_documento =   $this->registro_padre["radi_nume_text"];
...
//                    $this->datos_doc_destinatario .= "<br><b>".$this->formatear_datos_documento($usr["usua_cargo"],"I")."</b><br>&nbsp;<br>";
                ...
                default : //Oficios
                    ...
                    if (trim($usr["usua_cargo_cabecera"])!="") $this->datos_doc_destinatario .= "<b>".$this->formatear_datos_documento($usr["usua_cargo_cabecera"],"U")."</b><br>";
