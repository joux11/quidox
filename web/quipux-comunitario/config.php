...
$nombre_servidor="http://127.0.0.1:8081";
...
$servidor_firma = "http://host.docker.internal:8081/interconexion";

$servidor_viajes = "http://nombre_servidor_viajes";

$servidor_pdf = "http://host.docker.internal:8081/html_a_pdf";
