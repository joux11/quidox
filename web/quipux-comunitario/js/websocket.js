...
function token(tokencer,tipo_certificado,radicados,api_key_token){
      url = 'firmaec://'+api_key_token+'/firmar?token='+tokencer+'&tipo_certificado='+tipo_certificado+'&llx=222&lly=85&urx=422&ury=49&estampado=information2&pre=true&url=http://192.168.137.1:8080/api';
