    ...
    switch ($carpeta) {
        ...
        case 1:  // En elaboración
            ...
            $isql = "select -- En elaboracion $info_usuario_query
                    ...
                    ,to_char(fecha_documento AT TIME ZONE 'America/Guayaquil','YYYY-MM-DD HH24:MI:SS') || ' $descZonaHoraria' as \"DAT_Fecha Documento\"
        ...
        case 84:  // Ciudadanos Firma - Eliminados
            ...
            $isql = "select -- Eliminados $info_usuario_query
                    ...
                    ,ver_usuarios(radi_usua_dest,',') as \"Para\"
                     ,radi_asunto as \"Asunto\"
                    ,to_char(radi_fech_radi AT TIME ZONE 'America/Guayaquil','YYYY-MM-DD HH24:MI:SS') || ' $descZonaHoraria' as \"DAT_Fecha Documento\"
                    ,radi_nume_radi as \"HID_RADI_NUME_RADI\"
                    ,radi_nume_text as \"Número Documento\"
                    ,estado as \"Estado\"
                    ,radi_leido as \"HID_RADI_LEIDO\"
        ...
        case 7:  // No enviados, sin firma digital
            ...
            $isql = "select -- No enviados $info_usuario_query
                    ...
                    ,to_char(radi_fech_ofic AT TIME ZONE 'America/Guayaquil','YYYY-MM-DD HH24:MI:SS') || ' $descZonaHoraria' as \"DAT_Fecha Documento\"
                    ,radi_nume_radi as \"HID_RADI_NUME_RADI\"
                    ,radi_nume_text as \"Número Documento\"
                    ,radi_cuentai as \"No. Referencia\"                    
                    ,radi_leido as \"HID_RADI_LEIDO\"
        ...
        case 12:  // Bandeja Reasignados
            ...
            $isql = "select -- Bandeja Reasignados $info_usuario_query
                    ...
                    ,to_char(hist_fech AT TIME ZONE 'America/Guayaquil','YYYY-MM-DD HH24:MI:SS') || ' $descZonaHoraria' as \"DAT_Fecha Reasignación\"
                    ,radi_nume_radi as \"HID_RADI_NUME_RADI\"
        ...
        case 13: // Bandeja Informados
            ...
            $isql = "select -- Bandeja Informados $info_usuario_query
                    ...
                    ,to_char(info_fech AT TIME ZONE 'America/Guayaquil','YYYY-MM-DD HH24:MI:SS') || ' $descZonaHoraria' as \"DAT_Fecha Información\"
                    ,radi_nume_radi AS \"HID_RADI_NUME_RADI\"
                    ,radi_nume_text AS \"Número Documento\"                     
        ...
        case 86:  // Enviados
            ...
            $isql = "select -- Bandeja Enviados - Ciudadanos Firma $info_usuario_query                    ,case when radi_fech_firma is not null then '$firma' else '' end as \"SCR_\"
                    ...
                    ,to_char(fecha AT TIME ZONE 'America/Guayaquil','YYYY-MM-DD HH24:MI:SS') || ' $descZonaHoraria' as \"DAT_Fecha Documento\"
                    ,radi_nume_radi as \"HID_RADI_NUME_RADI\"
                    ,radi_nume_text as \"Número Documento\"
                    ,radi_cuentai as \"No. Referencia\"                    
                    ,1 as \"HID_RADI_LEIDO\"
