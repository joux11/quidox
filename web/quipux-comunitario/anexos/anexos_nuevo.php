...
// Escapamos el valor para evitar XSS
$asocImgRad = (isset($_POST["asocImgRad"])) 
    ? "<input type='hidden' name='asocImgRad' id='asocImgRad' value='" . htmlspecialchars($_POST["asocImgRad"], ENT_QUOTES, 'UTF-8') . "'>" 
    : "";

?>
<div id="div_anexos_estado" style="display:none"></div>
<b>Puede subir archivos con un tamaño máximo de: <?=htmlspecialchars(str_replace('M','',ini_get('upload_max_filesize')), ENT_QUOTES, 'UTF-8');?> MB</b>
